...
namespace AirflightsDataAccess.Migrations
{
    ...
    [Migration("20201118153039_RolesCodeIsUnique")]
    partial class RolesCodeIsUnique
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AirflightsDataAccess.Entities.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("AirflightsDataAccess.Entities.UserRole", b =>
                {
            ...
            modelBuilder.Entity("AirflightsDataAccess.Entities.UserRole", b =>
                {
                    b.HasOne("AirflightsDataAccess.Entities.Role", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("AirflightsDataAccess.Entities.User", "User")
                        .WithMany("UserRoles")
